...
import com.project.featureflag.config.MySQLContextInitializer
...
@ContextConfiguration(initializers = [MySQLContextInitializer::class], classes = [FeatureFlagApplication::class])
@AutoConfigureMockMvc
class FeatureFlagControllerITVersion2 {
